    ...
    return (
      ...
      >
        ...
        <p className="text-justify text-md mb-2 font-normal">
          ...
          Mathematics and specializing in Computational Mathematics. I do web
          dev stuff and I'd love to do game dev in the future. I also made this
          website myself.
        </p>
        <p className="text-justify text-md mb-2 font-normal">
          よろしくお願いします。🙇
        ...
        <Timeline />
        <br />
        <h1 className="text-2xl underline underline-offset-4 mb-1">
          My Interests
        </h1>
        <ul className="list-disc text-md mb-2 font-normal ml-4">
          <li className="mb-1">
            Music - Ye / City Pop / Joe Hisaishi
            <a
          ...
          <li className="mb-1">
            Movies - Good Burger / The Nice Guys / Your Name / SpiderMan 3 / DB:
            Broly and Superhero
          </li>
          <li className="mb-1">
          ...
          <li className="mb-1">
            Hobbies - Playing Games / Learning Languages 🇯🇵 / Lifting
          </li>
        </ul>
      </motion.div>
    );
